...
export default class AdminUserPreference extends React.Component{
    ...
    ViewLevel(levelno){
        ...
        this.props.navigation.navigate("AdminManageTask",{levelno:levelno});
    }
    preferedDays=()=>{
    ...
    return (
        <Container>
          ...
          <Icon size={25} name="home" style={{color: '#fff'}}  onPress={()=>
            ...
            <Content>
                <View>
                <TextInput placeholder="Days" style={{width:'90%',borderBottomWidth:2,
                ...
                <Text style={{justifyContent:'center',alignItems:'center',
                             marginTop:30,alignSelf:'center'}}>Levels of Viewing</Text>
                <View style={{marginTop:150,flexDirection:'row',justifyContent:'center'}}>
                    ...
                    <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
                        <TouchableOpacity style={{ margin: 5,backgroundColor:'#00A2C1',padding:19,
                                                   height:30,alignItems:"center" ,justifyContent:'center',
                                                   borderRadius:10}} 
                                                   onPress={this.resetDays}>
                                    <Text style={{color:'white'}}>Reset</Text>
                        </TouchableOpacity>
                        <TouchableOpacity style={{ margin: 5,backgroundColor:'#00A2C1',
