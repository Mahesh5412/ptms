...
class ListItem extends React.Component {
  ...
  //alert for verify the Project start
  ProjectVerify() {
  ...
  //alert for verify the Project end

  //verify the project start
          ...
          <View style={styles.signup}>
            <View style={[styles.buttonContainer, styles.signupButton]} >
              ...
              <View style={{ flexDirection: 'row', justifyContent: 'flex-end', alignItems: 'center' }}>
                <TouchableOpacity onPress={() => { this.ProjectVerify() }} style={{ width: 51, backgroundColor: 'green' }}><Text style={{ color: '#fff', textAlign: 'center' }}>VERIFY</Text></TouchableOpacity>
...
export default class Aproved1 extends Component {
  ...
  async componentDidMount() {
    ...
    this.adminApprovedProjects(this.state.role, this.state.userToken, this.state.cropcode)//AdminApproved 
  }

  //get AdminApprovedProjects list start
  adminApprovedProjects(role, userToken, cropcode) {
