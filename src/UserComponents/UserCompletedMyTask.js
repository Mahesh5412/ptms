/*
FileName:UsercompletedMyTasks.js
Version:1.0.0
Purpose:Getting the List of user completed sub task list
...
export default class Completed extends Component {
  ...
  //to refresh the data
  onRefresh() {
    this.setState({ isFetching: true }, function () { this.userCompletedMyTasks()});
  }
