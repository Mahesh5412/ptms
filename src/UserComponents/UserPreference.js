...
export default class UserPreference extends React.Component {
    ...
    componentDidMount() {
        ...
        log("Debug", "user userpreference screen is loaded");
    }
    //sending levels to UserManageTask 
    ViewLevel(levelno) {
        console.warn("lllllnaevve" + levelno);
        AsyncStorage.setItem('levelno', levelno);
        this.props.navigation.navigate("UserManageTask");
    }
    //sending levels to UserManageTask  preferedDays
    preferedDays = () => {
    ...
    //sending levels to UserManageTask resetDays 
    resetDays = () => {
        // alert(this.state.nodays);
        ...
        return (
            <Container>
                <Header
                    ...
                    <Left>
                        <Icon size={25} name="md-menu" style={{ color: '#fff' }} onPress={() =>
                    ...
                    <Right>
                        <Icon size={25} name="ios-home" style={{ color: '#fff' }}
