/*
FileName:UserRequestedDataProjects.js
Version:1.0.0
Purpose:Getting the List of user requested projects in user role
...
export default class Requesteddata extends Component {
  ...
  //to refresh the requested list data in user role
  onRefresh() {
  ...
  //to get the user requested projects datalist 
  getdata() {
