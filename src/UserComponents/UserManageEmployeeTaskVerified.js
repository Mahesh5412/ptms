        ...
        <Collapse style={styles.container}>
          ...
          <CollapseBody>
            ...
            <View style={{ flexDirection: 'row', paddingRight: 35, }}>
              ...
              <Text style={styles.signUpText111} >{item.subTaskDesc}</Text>
...
export default class Verified extends Component {
  ...
  componentDidMount() {
    ...
    log("Debug", "user Manageemployee view verified tasks screen is loaded");
  ...
  getEmployeesPendingTaskList() {
    log("Info", "UserManageEmployeeTaskVerified:getEmployeesPendingTaskList() method is used to get employee verified tasks");
              ...
              fetch(API + 'getSubtasks.php',
                ...
                .then((responseJson) => {
                  ...
                  if (responseJson.status === 'True') {
                    ...
                    log("Info", "no employee verified tasks at user side");
                    this.setState({
                      isLoading: false,
                    })
                    Snackbar.show({
                ...
                .catch((error) => {
                  console.error(error);
                  log("Error", "Error in getting employee verified tasks at user side");
                });
            }
          });
        });
