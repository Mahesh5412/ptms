/*
FileName:UserManageEmployeesTasks.js
Version:1.0.0
Purpose:Employess task details of Pending,Completed and verified
...
import Pending from '../UserComponents/UserManageEmployeeTaskPending';
import Completed from '../UserComponents/UserManageEmployeeTaskCompleted';
import Verified from '../UserComponents/UserManageEmployeeTaskVerified';


export default class UserManageEmployeesTasks extends Component {
    render() {
        ...
        return (
            <Container>
                <Header
                    ...
                    onPress={() => this.props.navigation.navigate("EditUser",{empId:this.props.navigation.state.params.empId,
