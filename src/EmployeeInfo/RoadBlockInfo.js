/*
FileName:CriticalRoadBlockList.js
Version:1.0.0
Purpose:Getting the List of CriticalRoadBlock list
...
import { Icon, Left, Button, Container, Header, Title, Body, Content, Item, Input } from 'native-base';
...
export default class RoadBlockInfo extends Component {
    ...
    componentDidMount() {
        //getting the CompletedMyTask List
        log("Debug", "getting the CompletedMyTask List");
                    ...
                    fetch(API + 'roadBlock.php',
                        ...
                        .then((responseJson) => {
                            ...
                            if (responseJson.status === 'True') {
                                ...
                                this.arrayholder = [];
                                log("Warn", "no completed projects found");
                                this.setState({

                                    isLoading: false,
                                })
                                Snackbar.show({
                                    title: 'No Critical RoadBlocks',
        ...
        return (
            <Container style={{ height: Dimensions.get('window').height }}>
                <Header
                    ...
                    <Left>
                        <Icon name="arrow-back" size={25} style={{ color: 'white' }} onPress={() =>
                            this.props.navigation.goBack(null)} />
                    </Left>
                    <Body>
                        <Title style={{ color: '#fff', fontWeight: '600' }}>Road Blocks</Title>
                    </Body>
